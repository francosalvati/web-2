                    ...
                    <div class="card p-1 bg-light mx-2">
                        <div>
                            <a href="canciones/<?php echo $album->id ?>">
                                <img src="<?php echo $album->imgURL ?>" class="images img-thumbnail" height="230" >
                            </a>
                        </div>
             ...
             {/foreach}
                <div class="col">
                    <div class="card p-1 bg-light mx-2">
                        <div>
                            <a href="admin">
                                <img src="https://us.123rf.com/450wm/siamimages/siamimages1611/siamimages161100055/65441642-a%C3%B1adir-signo-m%C3%A1s-ic%C3%B3nico-dise%C3%B1o.jpg?ver=6" class="images img-thumbnail" height="230" >
                            </a>
                            </div>
                                <div class="card-body p-2">
